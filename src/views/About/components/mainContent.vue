...
// 定义 currentPage 变量
const currentPage = ref('aimAndScope'); // 默认显示 Aim and Scope 内容

export { currentPage }; // 导出 currentPage 变量
</script>

<template>
<div>
    <div v-if="currentPage === 'aimAndScope'">
    ...
    <div v-else-if="currentPage === 'team'">
      02
    </div>
    <div v-else-if="currentPage === 'collaborator'">
      03
    </div>
    <div v-else-if="currentPage === 'contactUs'">
      04
    </div>
